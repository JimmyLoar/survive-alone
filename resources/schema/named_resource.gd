...
@export var code_name : StringName = "code_name":
	set(value):
		...
		visible_name = TranslationServer.translate("%s_%s_NAME" % [_resource_type, code_name.to_upper()])
		discription = TranslationServer.translate("%s_%s_DISCRIPTION" % [_resource_type, code_name.to_upper()])
...
@export_custom(	PROPERTY_HINT_TYPE_STRING, "", 
	PROPERTY_USAGE_READ_ONLY + PROPERTY_USAGE_DEFAULT
		...
		get(): return TranslationServer.translate("%s_%s_NAME" % [_resource_type, code_name.to_upper()])
@export_custom(PROPERTY_HINT_MULTILINE_TEXT, "", 
	PROPERTY_USAGE_READ_ONLY + PROPERTY_USAGE_DEFAULT
	) var discription : String = '':
		get(): 
			return TranslationServer.translate("%s_%s_DISCRIPTION" % [_resource_type, code_name.to_upper()])
