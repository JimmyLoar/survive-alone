...
func open_menu_screen():
	var packed_screen: PackedScene = load(
		"res://!tools/game_editor/screens/menu_screen/game_editor__menu_screen.tscn"
	)
...
func open_editor_screen(game_db_path: String):
	var packed_screen: PackedScene = load(
		"res://!tools/game_editor/screens/editor_screen/game_editor__editor_screen.tscn"
	)
